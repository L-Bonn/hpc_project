...
double &alpha, double &beta, double &checksum){
    ...
    #pragma acc parallel loop present(u, v, u_new, v_new, n, dt, alpha, beta) reduction(+:checksum)
...
void simulate(int &num_steps, int &n, vector<double> &u, vector<double> &v, int Lx, int Ly, const double &dx, double &dt,
    ...
    #pragma acc data copyin(n, dt, alpha, beta) copy(u, v, u_new, v_new, checksum)
    {
